        ...
        <div class="container">
            ...
            <div class="column-row">
                <div class="col col-sidebar left">
                    ...
                    <div class="events-list-menu">
                        <?= view_cell('\App\Libraries\Page::showMenu', ['id_menu' => 11, 'id_lang' => $id_lang, 'locale' => $locale, 'template' => 'sidebar', 'submenu_levels' => 0]) ?>
                    </div>
                ...
                <div class="col col-content">
                    ...
                    ?>
                    <?= view('\Modules\Event\Views\user/list\_events_list_search.php', array('today_time' => $today_time, 'data' => $data)) ?>
                    ...
                    <?php if (!empty($data['list'])): ?>
                                                    ...
                                                    <div class="details">
                                                        <div class="date">
                                                            <?php if (!empty($event['date'])): ?>
                                                                <div class="date-cont">
                                                                    <strong><?=date('d', strtotime($event['date'])); ?></strong>
                                                                    <span><?=lang('Admin.months_short_names.' . date('F', strtotime($event['date']))); ?></span>
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div class="place">
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <p class="no-results"><?=lang('Event.user.NoResults'); ?></p>
                    <?php endif; ?>
                </div>
        </div> 	
    </section>
