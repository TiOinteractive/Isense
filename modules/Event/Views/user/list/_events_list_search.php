    ...
    <div class="search-engine-2">
        ...
        <form action="/<?= $data['form_url']; ?>" method="get" class="events-form">
            <div class="search-top">
                <input class="field" type="hidden" name="t" value="<?=!empty($data['filters']['t']) ? $data['filters']['t'] : ''; ?>" />
                <div class="filter-box filter-date">
                    <p class="label"><?=lang('Event.user.Date'); ?>:</p>
                    <input class="field" type="text" name="d" value="<?=!empty($data['filters']['d']) ? $data['filters']['d'] : ''; ?>" autocomplete="off" />
                ...
                <div class="filter-box filter-search">
                    <input class="field" type="text" name="s" value="<?=!empty($data['filters']['s']) ? urldecode($data['filters']['s']) : ''; ?>" placeholder="<?=lang('Event.user.FindEvent'); ?>" autocomplete="off" />
