<?php
/* 
Najblizsze imprezy - sidebar
*/
?>
<?php if(!empty($data) && !empty($data['list'])): ?>
    <section class="section-<?=$id_cont; ?> closest-events-list events-list sidebar">
        <div class="container">
            <?php if(!empty($title)): ?> 
            ...
            <?php elseif($url):?>
                <div class="btn-box">
                    <a class="btn more" href="<?=$url; ?>" title="<?=esc(lang('User.entertainment.SeeAllEvents')); ?>"><?=lang('User.entertainment.SeeAllEvents'); ?></a>
                </div>
            <?php endif; ?>
        </div> 	
    </section>
