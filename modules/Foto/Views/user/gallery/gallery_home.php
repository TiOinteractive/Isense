...
<section class="section-<?=$id_cont; ?> home-gallery-list">
    <div class="container">
    	<?php if(!empty($title)): ?> 
	 <div class="title">
            <h2><a href="/foto/fotorelacje"><?=$title; ?></a></h2>
 ...
 <div class="list">
		...
		<p class="link-foto-all"><a href="/foto/fotorelacje">Zobacz wszystkie</a></p>	
