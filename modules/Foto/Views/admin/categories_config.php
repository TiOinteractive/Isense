<div class="form-row">
    ...
    <div class="form-field">
        <select name="config[order]">
			...
			<option value="number_photo"<?php if(!empty($page_content['config']) && !empty($page_content['config']['order']) && $page_content['config']['order']=='number_photo'):?> selected="selected"<?php endif; ?>><?=lang('Foto.OrderNumberPhoto'); ?></option>
