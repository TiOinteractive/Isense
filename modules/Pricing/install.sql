...
--
-- UWAGA: jeżeli baza używa prefiksu tabel (DBPrefix w .env, np. `tio_`),
-- dopisz go do KAŻDEJ nazwy tabeli poniżej — również do `module` i `module_lang`.
--
...
CREATE TABLE IF NOT EXISTS `pricing_category_lang` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pricing_service` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_category` int(11) NOT NULL,
  `order` int(11) NOT NULL DEFAULT 0,
  `publish` tinyint(1) NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `pricing_service_lang` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `module` (`slug`, `main`, `publish`, `separate`, `created_at`, `ico`) VALUES
...
INSERT INTO `module_lang` (`id_module`, `id_lang`, `name`, `created_at`)
