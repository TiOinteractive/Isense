...
<section class="section-<?=$id_cont; ?> slider-<?=$id_cont; ?> flavor-carousel">
        <?php if(!empty($title)): ?>
    ...
    <div class="list">
       <?php foreach($data['list'] as $place):?>
          <div class="item<?php if(!empty($place['awarded'])):?> awarded<?php endif;?>">
		    <div class="inside">
					 <figure>
						...
						<?php if(!empty($place['awarded'])):?><span class="ico_award">Wyróżniony</span><?php endif;?>
					</figure>
					<div class="flex">
					<div class="left">
					<div class="cat">
					...
					<header>
					  ...
					  <div class="address">
					   <?php if(!empty($place['address']) and substr($place['address'],0,3)!='ul.' and substr($place['address'],0,3)!='Al.'):?>ul.<?php endif;?> <?=$place['address'];?>
					  </div>
					</div>  
					<div class="rating">
