        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
            <div class="flex flex-col items-center text-center">
                <div class="relative h-72 w-full flex items-end justify-center mb-6">
                    <?= isense_img('intro-technician.png', 'Serwisant Apple', 'h-full w-auto object-contain', ['sizes' => '288px']) ?>
                </div>
            ...
            <div class="flex flex-col items-center text-center">
                <div class="relative h-72 w-full flex items-end justify-center mb-6">
                    <?= isense_img('intro-courier.png', 'Naprawa wysyłkowa — kurier', 'h-full w-auto object-contain', ['sizes' => '288px']) ?>
                </div>
