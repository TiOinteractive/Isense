        ...
        <div class="container">
            <div class="center-box">
                <div class="center-box-cont">
                    ...
                    <div class="inside">
                        <form action="<?=$locale ? '/' . $locale : ''; ?>/<?= env('ADMIN_PANEL_SLUG'); ?>/new-password/<?=$token;?>" method="post">
                            <div class="before"></div>
                            <h1><?= lang('Signin.SetPassword'); ?></h1>
                            <?php if (isset($susscess)): ?>
                                <div class="form-group"> 
                                    <div class="alert alert-ok">
                                        <?= lang('Signin.Passchanged'); ?>
                                    </div>
                                </div>
                                <?php
                            elseif (isset($id) and $id > 0):
                                ...
                                <form action="<?= $locale ? '/' . $locale : ''; ?>/<?= env('ADMIN_PANEL_SLUG'); ?>/new-password/<?= $token; ?>" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="password" autocomplete="off" name="newpass" value="" placeholder="<?= lang('Signin.newpassword'); ?>"  class="form-control trans200" />
                                        <?php if(isset($errors) and isset($errors['newpass'])): ?>	
                                            <div class="alert alert-warning">
                                                <?= $errors['newpass']; ?>
                                            </div>
                                        <?php endif; ?>
                                        <p class="pass-info">
                                            <?= lang('Signin.Passinfo'); ?>
                                        </p>
                                    </div>
                                    <div class="form-group">
                                        <label><?= lang('Signin.Password'); ?>:</label>
                                        <input type="password" autocomplete="off" name="newpass2" value="" placeholder="<?= lang('Signin.repeatpassword'); ?>"  class="form-control trans200" />

                                        <?php if(isset($errors) and isset($errors['newpass2'])): ?>	
                                            <div class="alert alert-warning">
                                                <?= $errors['newpass2']; ?>
                                            </div>
                                        <?php endif; ?>
                                    ...
                                    <div class="center">
                                        <button type="submit" class="btn"><?= lang('Signin.Savepass'); ?></button>
                                    </div>     
                                </form>
                                <?php else: ?>
                                <div class="alert alert-warning">
                                    <?= lang('Signin.tokenincorrect'); ?>
                                </div>
