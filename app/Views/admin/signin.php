        ...
        <div class="container">
            <div class="center-box">
                <div class="center-box-cont">
                    ...
                    <div class="inside">
                        <form action="/<?= env('ADMIN_PANEL_SLUG'); ?>/loginAuth" method="post">
                            <div class="before"></div>
                            <h1><?=lang('Signin.LoginToCms'); ?></h1>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="email" value="<?= set_value('email') ?>" placeholder="<?= lang('Signin.EnterYourLoginOrEmailAddress'); ?>" class="form-control trans200" >
                            </div>
                            <div class="form-group">
                                <label><?= lang('Signin.Password'); ?>:</label>
                                <input type="password" name="password" placeholder="<?= lang('Signin.EnterPassword'); ?>" class="form-control trans200" >
                            </div>
                            <div class="form-group lost-password">
                                <a href="/<?= env('ADMIN_PANEL_SLUG'); ?>/lost-password" title="<?= lang('Signin.RemindPassword'); ?>" class="trans200"><?= lang('Signin.RemindPassword'); ?></a> 
                            </div>
                            <div class="center">
                                <button type="submit" class="btn"><?= lang('Signin.login'); ?></button>
                            </div>     
                            <div class="after"></div>
                        </form>
                    </div>  
