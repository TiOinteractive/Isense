                        ...
                        <ul>
                            <?php foreach($m['submenu'] as $s): ?>
                                <li<?php if(isset($s['active']) && $s['active']==1) { echo ' class="active"';}?>>
                                    <a href="<?=$s['url']; ?>" title="<?=esc($s['title']); ?>" <?php if($s['target']){echo ' target="'.$s['target'].'"';}?>><?=$s['name']; ?></a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    <?php endif; ?>
