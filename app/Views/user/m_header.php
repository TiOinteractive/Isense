<header class="main-header">
        <div class="top-header">
			...
			<?php if(!empty($settings['logo'])):?>
                <div class="logo">
                    <a href="/<?=$locale;?>" title="<?=$settings['company_name'];?>" class="logo_link"><?php if(!empty($settings['logo_svg'])):?><?=$settings['logo_svg'];?><?php else:?><img src="/image/r/300/100/<?=$settings['logo']['path'];?>" alt="<?=$settings['company_name'];?>" /><?php endif;?></a>
