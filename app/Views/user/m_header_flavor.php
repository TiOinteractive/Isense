<header class="main-header-flavor" id="mobile-flavor-head">
  <div class="inside">
	...
	<div class="navbar-fluid">
		  ...
		  <div class="container">
			  <div class="head">	
				<?php if(!empty($settings['logo_flavor'])):?>
					<div class="logo">
						<a href="/rzeszowskie-smaki"><img src="/image/r/300/70/<?=$settings['logo_flavor']['path'];?>" alt="<?=$settings['company_name'];?>" class="trans400" /></a>
					</div>
				<?php endif; ?>
	  ...
	  <div class="mobile-menu trans800">
	  <div class="login">
			<?php if(empty($session_user)): ?>
              <a href="/<?=$global_links['login']; ?>" title="<?=lang('Users.account.LogIn'); ?>" class="log-in-ajax"><svg viewBox="0 0 32 32"><path d="M16,20a8,8,0,1,1,8-8A8,8,0,0,1,16,20ZM16,6a6,6,0,1,0,6,6A6,6,0,0,0,16,6Z"/><path d="M30,32H28A12,12,0,0,0,4,32H2a14,14,0,0,1,28,0Z"/></svg> <span class="name">Zaloguj się</span></a><?php else: ?>
              <a href="/<?=$global_links['client_account']; ?>" title="<?=lang('Users.account.YourAccount'); ?>"><svg viewBox="0 0 32 32"><path d="M16,20a8,8,0,1,1,8-8A8,8,0,0,1,16,20ZM16,6a6,6,0,1,0,6,6A6,6,0,0,0,16,6Z"/><path d="M30,32H28A12,12,0,0,0,4,32H2a14,14,0,0,1,28,0Z"/></svg> <span class="name"><?=!empty($session_user['name']) ? $session_user['name'] : lang('Users.account.YourAccount'); ?></span> </a>
            <?php endif; ?>
	  </div>
	...
	<div class="black-header">
		<div class="container">
			<div class="search-box">
				...
				<div class="map">
					<a href="/rzeszowskie-smaki/mapa-lokali"><svg viewBox="0 0 16 16"><path d="M8,16c0,0,6-5.582,6-10s-2.686-6-6-6S2,1.582,2,6S8,16,8,16z M5,5c0-1.657,1.343-3,3-3s3,1.343,3,3S9.657,8,8,8S5,6.657,5,5  z"/></svg> ZOBACZ MAPĘ LOKALI</a>
				</div>
			</div>
		</div>
	</div>
