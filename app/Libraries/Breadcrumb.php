...
class Breadcrumb
{
    ...
    public function __construct()
    {
        ...
        $this->tags['olopen']   = "<ul class=\"breadcrumb\">";
    ...
    public function add($crumb, $href)
    {
        ...
        if($crumb=="Home") {$crumb='<i class="fa-sharp fa-solid fa-house trans400"></i>';} 
    ...
    public function render()
    {
        ...
        $output .= '<a href="javascript: history.go(-1);"><i class="fa-solid fa-chevron-left trans400"></i> ';
        $output .= lang('Admin.Back');
        $output .= '</a>';
